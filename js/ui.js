/**
 * ui.js
 * Utilitários de interface: tema, sessão, tooltip e helpers visuais.
 */
...
/* ==============================================
   ANIMAÇÃO DE ERRO NO CAMPO (shake)
   ============================================== */
/**
 * Anima o campo com um shake horizontal para indicar erro.
 * @param {string} id - ID do elemento a ser animado.
 */
...
/* ==============================================
   ...
   ============================================== */
/**
 * Retorna o HTML da pill de status do material.
