/**
 * login.js
 * Gerencia a tela de login, logout e animação de transição.
 */

const Login = {
  /* Credenciais aceitas (em produção usar autenticação real) */
  VALID_MIN_PASS_LENGTH: 3,
  ...
  submit() {
    ...
    if (pass.length < this.VALID_MIN_PASS_LENGTH) {
